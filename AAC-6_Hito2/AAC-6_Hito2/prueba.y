...
expr: IDENTIFICADOR  DOSPUNTOS_IGUAL calc {
	...
	if (globalError ==0) { //No hay errores
      ...
      |sentencia_if {printf("Sentencia IF\n");}
...
calc:  calc MAS calc { 
	...
	| calc MAYOR_Q calc //{fprintf(yyout, "Condicion\n");} *COMPROBAR CONDICION $$.boolean si es 0 no se cumple y si 1 se cumple
	| calc MENOR_Q calc //{fprintf(yyout, "Condicion\n");}
	| calc IGUAL calc
...
sentencia_if: IF condicion THEN SALTOLINEA sentencia SALTOLINEA ENDIF //{$$ = newflow('I', $2, $5, NULL); }
	| IF condicion THEN SALTOLINEA sentencia SALTOLINEA ELSE SALTOLINEA sentencia SALTOLINEA ENDIF// { $$ = newflow('I', $2, $5, $9); }


;


bucle_while: WHILE calc LOOP SALTOLINEA expr SALTOLINEA ENDLOOP 
{ 
	$$.f = newflow('W', $2.f, $5.f);
};
